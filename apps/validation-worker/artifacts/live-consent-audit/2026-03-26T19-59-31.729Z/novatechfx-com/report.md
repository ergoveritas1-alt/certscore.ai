...
## 1. Executive summary
- overall testing status: partially completed with blocking or anti-automation issues on some scenarios
- strongest observed risks: none surfaced by the current run
- confidence level: low
- manual review recommended: yes

## 2. Consent UX scorecard
- banner present: inconclusive
...
- what changed after reject: reject scenario did not capture a stable post-choice storage snapshot
...
## 5. Findings list
- no evidence-backed findings were generated from this run
