...
const discoveryDocument = {
  ...
  capabilities: {
    ...
    interpretation:
      "Accept is a score-neutral comparison baseline. Accept and Reject afterAction summaries retain observed click and capture facts independently of consent registration. Reject findings require canonical qualifying evidence: confirmed refusal with eligible activity, or a completed Reject click with independently verified tracking evidence under the Reject-click review policy. GPC v3 observation completion is separate from the paired comparison and does not mean GPC was honored. Scoring and legal interpretation remain downstream in concern policy."
  },
  aiDiscovery: {
  ...
  mcp: {
    ...
    light: {
      ...
      longDescription: "Free website privacy scanner and cookie checker for public websites. Detect pre-consent cookies and trackers, third-party tracking technologies, cookie banners, CMP and consent-management signals, eligible Accept and Reject Path observations with their coverage state, privacy-policy and transparency findings, GDPR/ePrivacy and CCPA/CPRA review signals, and HTTPS/TLS transport observations. Accept is a score-neutral comparison baseline; Reject can support a finding after confirmed refusal with qualifying retained evidence, or a completed Reject click with independently verified tracking evidence. After-click observations remain useful when consent registration is unconfirmed. Give CertScore.ai a public website to collect structured, evidence-backed privacy findings for launch review, vendor review, audit triage, or human compliance review. Results include a CertScore score and supporting evidence for human and agentic review; they are not legal advice, certification, or a compliance determination.",
