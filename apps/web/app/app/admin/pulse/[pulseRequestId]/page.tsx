...
export default async function AdminPulseDetailPage({ params }: AdminPulseDetailPageProps) {
  ...
  return (
    <div className="space-y-6">
      <Link className="app-raised-button inline-flex rounded-lg px-3 py-2 text-sm font-semibold text-sky-700" href="/app/admin/pulse">
...
function AdminLink({ href, label }: { href: string; label: string }) {
  return (
    <Link className="app-raised-button block rounded-lg px-3 py-2 font-semibold text-sky-700" href={href}>
      {label}
    </Link>
  );
}
