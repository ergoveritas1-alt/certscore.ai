      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="border-slate-200 bg-white">
          ...
          <CardContent className="space-y-2 text-sm text-slate-700">
            ...
            <Field label="API key" value={getString(request.requestedBy, "apiKeyId") ?? "Not recorded"} />
            <Field label="Account" value={getString(request.requestedBy, "accountId") ?? "Not recorded"} />
            <Field label="User" value={getString(request.requestedBy, "userId") ?? "Not recorded"} />
