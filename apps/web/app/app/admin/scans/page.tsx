    ...
    <Card className="min-w-0 overflow-hidden border-slate-200 bg-white">
      ...
      <CardContent className="min-w-0 space-y-3 pt-0">
        ...
        <AdminScansFilterForm hasFilters={hasFilters}>
          <input aria-label="Filter by domain, scan ID, email, requester, IP, or source" className="h-10 min-w-[28rem] flex-[1_1_32rem] rounded-lg border border-slate-300 bg-white px-3 text-sm" defaultValue={activeQuery} name="q" placeholder="Domain, scan_id, email, requester, IP · source:homepage-anonymous" />
