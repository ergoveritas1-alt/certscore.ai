  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <article className="mx-auto max-w-3xl space-y-8 px-6 py-16">
        ...
        <section className="space-y-3"><h2 className="text-2xl font-semibold">Evidence collected</h2><p className="leading-7 text-slate-700">The extension may collect the target URL and hostname, bounded network request and response metadata, cookie names and attributes, visible consent-interface evidence, browser-observed fingerprinting signals, scan timing, transport/form/embed metadata, linked legal-surface URLs, and bounded visible text from selected legal surfaces. The extension does not capture screenshots.</p></section>
