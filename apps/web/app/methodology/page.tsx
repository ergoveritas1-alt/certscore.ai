...
export const metadata: Metadata = createPageMetadata({
  description:
    "Review CertScore.ai methodology for evidence collection, confidence scoring, limitations, and posture-based regulatory findings.",
  path: "/methodology",
  title: "Methodology"
});
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-5xl px-6 py-16">
          <div className="max-w-3xl space-y-4">
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-slate-950">Evidence-first review methodology for posture-based findings.</h1>
