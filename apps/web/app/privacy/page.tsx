...
const sections = [
  ...
  },
  {
    ...
    body:
      "CertScore.ai uses third-party infrastructure and service providers, including Supabase, Vercel, Upstash Redis, Railway, Resend, and Google OAuth where applicable. These providers process data as part of authentication, hosting, job processing, storage, email delivery, and platform operation."
  },
  {
