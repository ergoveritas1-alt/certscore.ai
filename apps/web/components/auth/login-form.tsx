    ...
    <div className="space-y-[10px]">
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <span className="truncate text-xl font-semibold tracking-tight text-slate-950">Access your workspace</span>
        </div>
      ...
      <form action={formAction} className="space-y-4" onSubmit={handleCreateContinue}>
        ...
        {accountRecovery?.kind === "create_password" ? (
        ...
        {isCreateAccount ? <p className="text-xs text-slate-500">No credit card required.</p> : null}
      </form>
