            ...
            className={
              variant === "homepage-hero"
                ...
                ? scanButtonArmed
                  ...
                  : "absolute right-2 top-1/2 h-8 -translate-y-1/2 rounded-full border border-slate-200 bg-slate-100 px-4 text-xs font-semibold text-slate-400 shadow-inner focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2"
