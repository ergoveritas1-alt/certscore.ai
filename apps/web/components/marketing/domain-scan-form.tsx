          ...
          <Button
            ...
            className={
              variant === "homepage-hero"
                ...
                : compact
                ? scanButtonArmed
                  ? "absolute right-2 top-1/2 h-8 -translate-y-1/2 rounded-full border border-slate-700 bg-[linear-gradient(180deg,#111827_0%,#020617_100%)] px-4 text-xs font-semibold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_3px_0_0_rgba(148,163,184,0.45),0_8px_14px_-8px_rgba(15,23,42,0.7)] transition-all duration-150 hover:-translate-y-[calc(50%+1px)] hover:border-slate-600 hover:brightness-110 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.16),0_4px_0_0_rgba(148,163,184,0.4),0_10px_18px_-8px_rgba(15,23,42,0.8)] active:translate-y-[calc(-50%+1px)] active:shadow-[inset_0_2px_3px_rgba(0,0,0,0.35),0_1px_0_0_rgba(148,163,184,0.35)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2"
