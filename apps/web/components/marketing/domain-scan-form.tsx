          ...
          <Button
            ...
            className={
              variant === "homepage-hero"
                ...
                : compact
                ? scanButtonArmed
                  ? "absolute right-2 top-1/2 h-8 min-w-[4.5rem] -translate-y-1/2 rounded-full border border-sky-600 bg-[linear-gradient(180deg,#38bdf8_0%,#0284c7_100%)] px-4 text-xs font-bold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_3px_0_0_rgba(3,105,161,0.55),0_10px_22px_-7px_rgba(14,165,233,0.7)] ring-1 ring-sky-300/70 transition-all duration-150 hover:-translate-y-[calc(50%+1px)] hover:scale-[1.03] hover:border-sky-500 hover:brightness-110 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.4),0_4px_0_0_rgba(3,105,161,0.5),0_13px_24px_-7px_rgba(14,165,233,0.8)] active:translate-y-[calc(-50%+1px)] active:scale-[0.99] active:shadow-[inset_0_2px_3px_rgba(3,105,161,0.4),0_1px_0_0_rgba(3,105,161,0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2"
                  : "absolute right-2 top-1/2 h-8 min-w-[4.5rem] -translate-y-1/2 rounded-full border border-sky-400/80 bg-[linear-gradient(180deg,#60a5fa_0%,#2563eb_100%)] px-4 text-xs font-bold text-white/90 opacity-90 shadow-[inset_0_1px_0_rgba(255,255,255,0.25),0_3px_0_0_rgba(29,78,216,0.45),0_8px_16px_-8px_rgba(37,99,235,0.55)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2"
