...
export function runtimeGraphUiFixture() {
  const nodes: ApiRuntimeEvidenceGraph["nodes"] = [
    ...
    { id: "widget", kind: "script", label: "Widget script", url: "https://widget.fixture.test/widget.js", observedAtMs: 20 },
  ...
  return apiRuntimeEvidenceGraphProjectionSchema.parse({
    ...
    graphs: [graph, { ...graph, captureId: "ui-fixture:reject_observation", scenario: "post_reject", action: { status: "confirmed", registeredAtMs: 50 } }],
