...
export function SitePriorityReview({ findings, pending, sitewideAvailable }: { findings: SitePriorityFinding[]; pending: boolean; sitewideAvailable: boolean }) {
  ...
  return <section aria-label="Sitewide priority review" className="my-3 border-y border-zinc-200 bg-white py-3">
    <div className="flex items-center justify-between gap-3">
      <div><p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Priority review</p><h2 className="mt-1 text-xl font-semibold">Top issues across your site</h2></div>
