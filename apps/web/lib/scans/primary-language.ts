...
const COMMON_WORD_HINTS: Partial<Record<SupportedPrivacyEvidenceLocale, readonly string[]>> = {
  ...
  sk: ["pre", "ktoré", "sú", "táto", "vaše", "naše", "stránka", "všetky", "alebo", "údaje"],
  cs: ["pro", "které", "jsou", "tato", "vaše", "naše", "stránky", "všech", "jako", "nebo"],
  hr: ["za", "koje", "su", "ova", "vaše", "naše", "stranica", "sve", "ili", "podaci"],
  sl: ["za", "ki", "so", "ta", "vaše", "naše", "stran", "vse", "ali", "podatki"],
  lt: ["ir", "kad", "jūsų", "mūsų", "su", "ši", "visi", "svetainė", "yra", "duomenys"],
  lv: ["un", "kas", "jūsu", "mūsu", "ar", "šī", "visi", "vietne", "ir", "dati"],
  et: ["ja", "et", "teie", "meie", "koos", "see", "kõik", "veebisait", "on", "andmed"],
