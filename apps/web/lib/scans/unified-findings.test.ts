...
test("downgrades privacy absence-style findings under thin coverage", () => {
  const [packet] = buildUnifiedFindingDisplayPackets({
    coverageSummary: {
      legalCoverageScore: 0,
      pagesScanned: 1,
    ...
    reviewFindingCandidates: [
      {
        description: "No privacy contact channel was detected in the scanned coverage.",
        fallbackEvidence: {
        ...
        severity: "medium",
        signalKey: "privacy.privacy_contact_channel_missing",
        signalLabel: "Privacy contact channel missing",
        signalSource: "snapshot_signal",
        sourceType: "signal",
        title: "Privacy contact channel missing"
      }
    ],
    validationFindings: [],
    validationFindingLookup: new Map()
  ...
  assert.equal(packet?.unifiedFindingId, "privacy_contact_channel_missing");
