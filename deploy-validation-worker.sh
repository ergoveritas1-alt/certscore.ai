...
deploy_args=(
  ...
  --remove-env-vars "NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY,SUPABASE_STORAGE_BUCKET,SUPABASE_STORAGE_BUCKET_SCREENSHOTS,SUPABASE_STORAGE_BUCKET_ARTIFACTS"
  --remove-secrets "SUPABASE_SERVICE_ROLE_KEY"
)
