# WC01 v2 Human Reviewer Scorecard
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|---|---|---|---|
| `weather.com` | 5 | N/A | 4 | 3 | 5 | 4 | 4 | 4 | yes | yes | no | yes | yes | `needs_more_evidence` | Queue lane is clear and grouping makes the high-volume packet triageable. Top-N is not enough for first-pass full evidence adjudication because unresolved refs dominate the packet. JSON was useful for confidence/directness, but upstream inspection would still be needed for exhaustive review. |
| `segment.com` | 5 | N/A | 5 | 4 | 5 | 5 | 4 | 5 | yes | yes | yes | yes | no | `evidence_shape_confirmed` | Markdown clearly shows all three families and separates redacted source refs from fail-closed unresolved evidence. JSON was useful to confirm high confidence and directness. |
| `plannedparenthood.org` | 5 | 5 | 4 | 4 | 5 | 5 | 4 | 5 | yes | yes | yes | yes | no | `sensitive_context_escalated` | Sensitive-context routing is clear. Markdown is enough for queue and evidence-shape review, and JSON confirmed confidence/directness. Escalation is due to sensitive context only. |
| `greenhouse.com` | 5 | 5 | 4 | 4 | 5 | 5 | 4 | 4 | yes | yes | yes | yes | yes | `sensitive_context_escalated` | Employment / HR context is clear. Grouping is usable, but unresolved volume is high enough that final reviewer confidence would benefit from JSON and possibly upstream inspection. |
| `hotjar.com` | 5 | 5 | 5 | 4 | 5 | 5 | 4 | 5 | yes | yes | yes | yes | no | `sensitive_context_escalated` | Behavioral analytics reference lane is clear. Session replay / behavioral analytics groups are understandable, with Hotjar runtime and source-ref groups visible. JSON helped confirm confidence/directness. |
| `healthline.com` | 5 | 5 | 5 | 4 | 5 | 5 | 4 | 5 | yes | yes | yes | yes | no | `sensitive_context_escalated` | Health context is clear. Top-N groups are representative enough for first-pass review across tracking, cookie/storage, and behavioral analytics. JSON helped confirm confidence/directness. |
| `bankofamerica.com` | 5 | 5 | 5 | 5 | 5 | 5 | 4 | 5 | yes | yes | yes | yes | no | `sensitive_context_escalated` | Compact finance packet. Markdown is enough for first-pass review, with JSON useful only to confirm confidence/directness. |
| `benefits.gov` | 5 | 5 | 5 | 5 | 5 | 5 | 4 | 5 | yes | yes | yes | yes | no | `sensitive_context_escalated` | Public-benefits context is clear. Evidence groups and warning categories are compact and understandable. JSON helped confirm confidence/directness. |
| `target.com` | 5 | N/A | 5 | 5 | 5 | 5 | 4 | 5 | yes | yes | yes | yes | no | `evidence_shape_confirmed` | Standard-lane packet with all three families. Markdown clearly shows tracking, cookie/storage, and FullStory behavioral analytics shape. JSON helped confirm confidence/directness. |
| `cloudflare.com` | 5 | N/A | 5 | 5 | 5 | 5 | 4 | 5 | yes | yes | yes | yes | no | `evidence_shape_confirmed` | Compact standard-lane packet. Markdown is sufficient for first-pass review, and JSON confirmed confidence/directness. Diagnostic context remains separated from supporting evidence. |
