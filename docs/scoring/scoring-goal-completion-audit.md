...
| Critical caps prevent misleadingly strong core-gap scores | Consent/tracking, contradiction, and sensitive-data caps work. Twelve-lane benchmark found high-severity rights gap yields `75 / Clear / Monitor`. Three pending-Luna alternatives now clear the deterministic contradiction, but none is approved and retained replay lacks a rights-gap input. | **Contradicted in active v2; Luna model choice required** |
