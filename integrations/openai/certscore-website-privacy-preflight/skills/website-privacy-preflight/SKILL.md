...
Report only observed CertScore evidence and persisted CertScore classifications. Clearly distinguish `preConsentPreview` from the canonical completed bundle. Do not infer unobserved technologies, post-consent behavior, legal violations, or compliance. Results are not legal advice, certification, or a compliance determination.
