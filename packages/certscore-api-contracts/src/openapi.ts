    ...
    paths: {
      "/api/v1/pulse": {
        get: {
          ...
          description:
            `${PULSE_PURPOSE_STATEMENT} Use this endpoint for automated public-web observations for human and agentic review; outputs are not legal advice, certification, or a compliance determination.`,
          parameters: [
