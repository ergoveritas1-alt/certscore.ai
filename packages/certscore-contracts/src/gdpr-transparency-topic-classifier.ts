...
export const GDPR_TRANSPARENCY_TOPIC_PHRASE_REGISTRY: GdprTransparencyTopicPhrase[] = [
  ...
  ...fr([
    ...
    equivalent("controller_contact", "responsables de traitement"),
    ...
    equivalent("processing_purposes", "objectifs du recueil de ces données"),
    ...
    equivalent("legal_basis", "fondement juridique justifiant le traitement"),
    ...
    equivalent("data_retention", "durées de conservation"),
    equivalent("data_retention", "critères utilisés pour déterminer cette durée"),
    ...
    equivalent("data_subject_rights", "vos droits et de la façon de les exercer"),
    ...
    equivalent("international_transfers", "transfert hors union européenne"),
