...
export const GDPR_TRANSPARENCY_TOPIC_PHRASE_REGISTRY: GdprTransparencyTopicPhrase[] = [
  ...
  ...de([
    ...
    equivalent("processing_purposes", "zu den zwecken"),
    ...
    direct("legal_basis", "rechtsgrundlage der datenverarbeitung"),
    ...
    equivalent("recipients_or_vendor_categories", "eingesetzten drittanbietern"),
    equivalent("recipients_or_vendor_categories", "liste möglicher drittanbieter"),
    ...
    equivalent("data_retention", "solange dies für den jeweils"),
    ...
    equivalent("data_subject_rights", "rechte als betroffene person"),
    equivalent("data_subject_rights", "auskunft berichtigung löschung"),
    direct("international_transfers", "übermittlung personenbezogener daten in ein drittland"),
    equivalent("international_transfers", "staaten außerhalb des europäischen wirtschaftsraumes"),
    equivalent("international_transfers", "standardvertragsklauseln der eu-kommission"),
    ...
    direct("supervisory_authority", "beschwerderecht bei der zuständigen aufsichtsbehörde"),
    ...
    equivalent("automated_decision_making_or_profiling", "automatische entscheidungsfindung oder ein profiling"),
  ...
  ...es([
    ...
    equivalent("processing_purposes", "tratamos sus datos personales para"),
    equivalent("processing_purposes", "trataremos sus datos personales con la finalidad"),
    direct("legal_basis", "base jurídica del tratamiento de datos personales"),
    direct("legal_basis", "legitimación para el tratamiento de sus datos"),
    direct("legal_basis", "legitimación para el tratamiento de sus datos personales"),
    equivalent("legal_basis", "base legal que nos permite tratar sus datos"),
    ...
    equivalent("recipients_or_vendor_categories", "encargados del tratamiento"),
    equivalent("recipients_or_vendor_categories", "comunicaremos sus datos a terceros"),
    direct("data_retention", "plazo de conservación de datos personales"),
    equivalent("data_retention", "conservamos datos personales"),
    equivalent("data_retention", "conservaremos sus datos personales durante"),
    equivalent("data_retention", "datos personales serán conservados"),
    ...
    equivalent("data_subject_rights", "derechos de acceso rectificación supresión oposición limitación y portabilidad"),
    ...
    equivalent("international_transfers", "transferir sus datos personales a terceros países"),
    equivalent("international_transfers", "cláusulas contractuales tipo"),
  ...
  ...it([
    ...
    equivalent("processing_purposes", "trattiamo i tuoi dati personali per"),
    equivalent("processing_purposes", "i dati personali sono trattati per le seguenti finalità"),
    ...
    equivalent("legal_basis", "basi giuridiche del trattamento"),
    equivalent("legal_basis", "la base giuridica del trattamento dei dati personali è"),
    ...
    equivalent("recipients_or_vendor_categories", "soggetti autorizzati al trattamento"),
    direct("data_retention", "periodo di conservazione dei dati personali"),
    equivalent("data_retention", "conserviamo dati personali"),
    equivalent("data_retention", "dati personali saranno conservati"),
    equivalent("data_retention", "per il tempo necessario al perseguimento delle finalità"),
    ...
    equivalent("data_subject_rights", "diritti di accesso rettifica cancellazione limitazione opposizione e portabilità"),
    ...
    equivalent("international_transfers", "trasferire i dati personali verso paesi terzi"),
    equivalent("international_transfers", "clausole contrattuali standard"),
    ...
    equivalent("supervisory_authority", "reclamo al garante per la protezione dei dati personali"),
  ...
  ...nl([
    ...
    equivalent("controller_contact", "is verantwoordelijk voor de verwerking"),
    equivalent("controller_contact", "verantwoordelijk voor deze website"),
    ...
    equivalent("processing_purposes", "waarvoor gebruiken wij uw persoonsgegevens"),
    equivalent("processing_purposes", "hoe we jouw persoonsgegevens gebruiken"),
    equivalent("processing_purposes", "welke persoonsgegevens we van je verwerken wat we hiermee doen"),
    equivalent("processing_purposes", "waarom en hoe wij deze gegevens opslaan"),
    equivalent("processing_purposes", "waarom en hoe deze gegevens opslaat"),
    ...
    equivalent("recipients_or_vendor_categories", "aan wie geven wij uw gegevens door"),
    equivalent("recipients_or_vendor_categories", "met wie delen wij uw persoonsgegevens"),
    ...
    equivalent("data_retention", "hoe lang we die bewaren"),
    equivalent("data_retention", "hoe lang wij die bewaren"),
    equivalent("data_retention", "hoe lang bewaren wij"),
    equivalent("data_retention", "bewaartermijn gegevens"),
    ...
    equivalent("data_subject_rights", "welke rechten jij hierbij hebt"),
    equivalent("data_subject_rights", "welke rechten u heeft"),
    equivalent("data_subject_rights", "welke rechten heb je"),
    ...
    equivalent("supervisory_authority", "autoriteit persoonsgegevens ziet erop toe"),
  ...
  ...pl([
    ...
    equivalent("controller_contact", "administratorem danych osobowych przetwarzanych"),
    direct("dpo_contact", "inspektor ochrony danych"),
    direct("dpo_contact", "administrator wyznaczył inspektora ochrony danych"),
    direct("dpo_contact", "inspektorem ochrony danych osobowych"),
    equivalent("dpo_contact", "kontakt z iod"),
    equivalent("dpo_contact", "dopisek iod"),
    ...
    direct("processing_purposes", "w jakim celu i na jakiej podstawie prawnej przetwarzamy twoje dane"),
    equivalent("processing_purposes", "przetwarzać dane osobowe użytkowników w celu"),
    equivalent("processing_purposes", "dane osobowe przetwarzamy w następujących celach"),
    equivalent("processing_purposes", "przetwarzamy twoje dane osobowe w celu"),
    ...
    equivalent("legal_basis", "podstawą prawną przetwarzania jest"),
    equivalent("legal_basis", "podstawą przetwarzania jest"),
    ...
    equivalent("recipients_or_vendor_categories", "podmiotom przetwarzającym dane osobowe"),
    equivalent("recipients_or_vendor_categories", "podmioty powiązane z nami w ramach grupy kapitałowej"),
    equivalent("recipients_or_vendor_categories", "partnerzy biznesowi i dostawcy usług"),
    ...
    equivalent("data_retention", "nie dłużej niż jest to niezbędne"),
    equivalent("data_retention", "do czasu cofnięcia zgody"),
    equivalent("data_retention", "do czasu przedawnienia roszczeń"),
    ...
    equivalent("data_subject_rights", "przysługuje ci prawo"),
    equivalent("data_subject_rights", "prawo do sprostowania danych"),
    equivalent("data_subject_rights", "prawo do wniesienia sprzeciwu"),
    equivalent("data_subject_rights", "prawo do przenoszenia danych"),
    ...
    equivalent("international_transfers", "poza europejskim obszarem gospodarczym"),
    equivalent("international_transfers", "standardowe klauzule umowne"),
    ...
    equivalent("supervisory_authority", "prezes urzędu ochrony danych osobowych"),
    equivalent("supervisory_authority", "prezesa urzędu ochrony danych osobowych"),
    equivalent("supervisory_authority", "prawo wniesienia skargi do organu nadzorczego"),
    ...
    equivalent("automated_decision_making_or_profiling", "wykorzystujemy profilowanie"),
    equivalent("automated_decision_making_or_profiling", "profilowania dla celów marketingowych"),
  ]),
];
