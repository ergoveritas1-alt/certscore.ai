...
5. Stop polling at any terminal status. At `completed` or `completed_limited`, call `certscore_get_scan_bundle`; for other terminal states, follow the returned error guidance.
