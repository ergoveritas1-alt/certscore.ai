      ...
      messages: [
        {
          ...
          content: [
            ...
            "Inspect the whole visible banner or modal, including small text links at the top or bottom edge, before deciding reject/options are absent. A visible top-right Continue without agreeing link in a consent modal counts as Reject.",
