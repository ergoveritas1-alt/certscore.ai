...
const ARTICLE13_SECTION_PROFILES: Array<{
...
}> = [
  {
    ...
    headingPatterns: [/retaining your information/i, /retention/i, /dur[ée]e de conservation/i, /combien de temps/i, /quelles utilisations seront faites de vos donn[ée]es/i],
    textPatterns: [/retain/i, /retained/i, /retention/i, /deleted?/i, /deletion/i, /anonymi[sz]ed?/i, /remove/i, /expires?/i, /kept for/i, /legal purposes/i, /fraud and abuse prevention/i, /conserv(?:ons|[ée]e?s?)/i, /dur[ée]e/i, /dispositions l[ée]gales/i, /finalit[ée]s/i],
    observedPattern: /(?:retain|retained).{0,220}(?:as long as necessary|required by law|legal purposes|fraud|abuse|different periods)|deleted? or anonymi[sz]ed|kept until you remove|retention period|retention criteria|dur[ée]e de conservation|conserv(?:ons|[ée]e?s?).{0,180}(?:dur[ée]e|finalit[ée]s|dispositions l[ée]gales|n[ée]cessaire|proportionnelles?)/i,
  },
  {
    disclosureType: "data_subject_rights",
    headingPatterns: [/your privacy controls/i, /exporting.*deleting/i, /privacy controls/i, /de quels droits disposez-vous/i, /droits/i, /exercer vos droits/i],
    textPatterns: [/update/i, /manage/i, /export/i, /delete/i, /download a copy/i, /request/i, /remove content/i, /my activity/i, /google takeout/i, /privacy controls/i, /applicable law/i, /European Union or United Kingdom data protection law/i, /droit d['’]acc[èe]s/i, /rectification/i, /effacement/i, /opposition/i, /limitation/i, /portabilit[ée]/i, /retirer (?:votre )?consentement/i],
    observedPattern: /(?:right to|rights? to|data subject rights|exercise (?:your )?rights|request to (?:access|correct|delete|remove)|download a copy|google takeout|my activity|European Union or United Kingdom data protection law|droits? (?:d['’]acc[èe]s|d['’]opposition|de rectification|d['’]effacement|[àa] la limitation|[àa] la portabilit[ée])|exercer vos droits|retirer (?:votre )?consentement)/i,
    partialPattern: /(?:update|manage|export|delete|request|remove|download|access|correct|object|restrict|privacy controls|acc[èe]s|rectification|effacement|opposition|limitation|portabilit[ée]|droits?)/i,
  },
  {
    disclosureType: "international_transfers",
    headingPatterns: [/data transfers?/i, /international transfers?/i, /transferts?.*Union Europ[ée]enne/i, /transferts? internationaux/i],
    textPatterns: [/servers around the world/i, /processed? outside (?:your )?country/i, /outside (?:of )?the country where you live/i, /outside (?:the )?(?:eea|european economic area|uk|united kingdom|eu|european union)/i, /third countr(?:y|ies)/i, /legal frameworks? relating to the transfer of data/i, /data protection laws vary/i, /agreements?.{0,180}(?:protect|safeguard)/i, /adequacy/i, /safeguards/i, /EU-U\.S\. Data Privacy Framework/i, /UK Extension/i, /Swiss-U\.S\./i, /transferts?/i, /hors (?:de )?(?:l['’])?Union Europ[ée]enne/i, /espace [ée]conomique europ[ée]en/i, /clauses contractuelles types/i, /garanties appropri[ée]es/i],
    observedPattern: /servers around the world|processed? (?:on servers )?outside (?:your )?country|outside (?:of )?the country where you live|(?:third parties|service providers?|business partners?|processors?|vendors?|recipients?).{0,220}outside (?:the )?(?:eea|european economic area|uk|united kingdom|eu|european union)|agreements?.{0,220}(?:personal information|personal data|data|information).{0,220}(?:protect|protected|safeguard|outside (?:the )?(?:eea|european economic area|uk|united kingdom|eu|european union))|legal frameworks? relating to the transfer of data|data protection laws vary|adequacy|safeguards|EU-U\.S\. Data Privacy Framework|UK Extension|Swiss-U\.S\.|standard contractual clauses|transferts?.{0,220}donn[ée]es.{0,220}(?:hors (?:de )?(?:l['’])?Union Europ[ée]enne|espace [ée]conomique europ[ée]en|pays tiers|clauses contractuelles types|garanties appropri[ée]es)|hors (?:de )?(?:l['’])?Union Europ[ée]enne.{0,220}(?:donn[ée]es|traitement|transferts?)/i,
  },
  {
    disclosureType: "processing_purposes",
    headingPatterns: [/purpose/i, /why .*collect/i, /how we use/i, /finalit[ée]s/i, /pourquoi collectons-nous/i, /quelles utilisations seront faites de vos donn[ée]es/i],
    textPatterns: [/purpose/i, /we (?:use|process|collect)/i, /provide (?:our )?services/i, /personalize/i, /finalit[ée]s/i, /collectons/i, /utilis(?:ons|ations?)/i, /traitement des donn[ée]es/i],
    observedPattern: /(?:purpose(?:s)?|why we (?:process|collect|use)|we (?:use|process|collect) (?:your )?(?:personal )?(?:data|information) (?:to|for)|provide (?:our )?services|personalize)|(?:finalit[ée]s?|pourquoi collectons-nous|quelles utilisations).{0,260}(?:donn[ée]es|traitement)|(?:nous collectons|collectons|utilisons|traitons).{0,160}donn[ée]es.{0,260}(?:pour|afin de|finalit[ée]s|adapter|financer|personnaliser|mesurer)/i,
  },
  {
    disclosureType: "recipients_or_vendor_categories",
    headingPatterns: [/recipients?/i, /service providers?/i, /processors?/i, /destinataires?/i, /prestataires?/i, /sous-traitants?/i, /partenaires/i],
    textPatterns: [/recipients?/i, /service providers?/i, /processors?/i, /vendors?/i, /partners?/i, /destinataires?/i, /prestataires?/i, /sous-traitants?/i, /partenaires commerciaux/i, /soci[ée]t[ée]s? de son groupe/i, /autorit[ée]s comp[ée]tentes/i],
    observedPattern: /(?:recipients?|service providers?|processors?|vendors?|partners?|affiliates?).{0,220}(?:personal data|personal information|data|information|process|receive|access)|(?:sont destinataires des donn[ée]es|destinataires? des donn[ée]es).{0,320}(?:[ée]diteur|soci[ée]t[ée]s? de son groupe|prestataires?|sous-traitants?|partenaires commerciaux|autorit[ée]s comp[ée]tentes)|(?:prestataires?|sous-traitants?|partenaires commerciaux|autorit[ée]s comp[ée]tentes).{0,260}(?:donn[ée]es|traitement|acc[èe]s|re[çc]oivent|destinataires?)/i,
  },
  {
  ...
  },
  {
    ...
    headingPatterns: [/contact/i, /European requirements/i, /data protection/i, /d[ée]l[ée]gu[ée] [àa] la protection des donn[ée]es/i],
    textPatterns: [/privacy office/i, /data protection office/i, /data protection officer/i, /\bdpo\b/i, /contact (?:google|us)/i, /questions about this policy/i, /Google LLC/i, /Google Ireland Limited/i, /d[ée]l[ée]gu[ée] [àa] la protection des donn[ée]es/i, /dpo@/i],
    observedPattern: /data protection officer|\bdpo\b|d[ée]l[ée]gu[ée] [àa] la protection des donn[ée]es|dpo@[a-z0-9.-]+/i,
    partialPattern: /privacy office|data protection office|contact (?:google|us)|questions about this policy|Google LLC|Google Ireland Limited|protection des donn[ée]es/i,
  },
  {
    disclosureType: "controller_contact",
    headingPatterns: [/contact/i, /European requirements/i, /controller/i, /responsable du traitement/i, /qui sommes-nous/i, /[ée]diteur/i],
    textPatterns: [/contact Google/i, /contact us/i, /questions about this policy/i, /privacy office/i, /data protection office/i, /data protection officer/i, /Google LLC/i, /Google Ireland Limited/i, /responsable du traitement/i, /supports? num[ée]riques? (?:est|sont) [ée]dit[ée]s? par/i, /[ée]diteur/i],
    observedPattern: /data controller|\bcontroller\b|privacy@|contact (?:us|our privacy team).{0,120}(?:privacy|data protection)|responsable du traitement|supports? num[ée]riques? (?:est|sont) [ée]dit[ée]s? par/i,
    partialPattern: /Google LLC|Google Ireland Limited|contact Google|questions about this policy|privacy office|data protection office|[ée]diteur|contact protection des donn[ée]es/i,
  },
  {
    disclosureType: "legal_basis",
    headingPatterns: [/legal basis/i, /lawful basis/i, /European requirements/i, /fondement juridique/i, /base l[ée]gale/i],
    textPatterns: [/Article 6/i, /legitimate interests/i, /consent/i, /contract/i, /legal obligation/i, /public task/i, /vital interests/i, /required by law/i, /fondement juridique/i, /base l[ée]gale/i, /int[ée]r[êe]t l[ée]gitime/i, /obligation l[ée]gale/i, /ex[ée]cution du contrat/i],
    observedPattern: /legal basis|lawful basis|Article 6|legitimate interests?|performance of (?:a )?contract|contractual necessity|legal obligation|public task|vital interests|fondement juridique|base l[ée]gale|int[ée]r[êe]t l[ée]gitime|obligation l[ée]gale|ex[ée]cution du contrat/i,
    partialPattern: /required by law|consent|consentement/i,
  },
  {
