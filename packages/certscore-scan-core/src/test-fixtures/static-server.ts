...
function policyHomeMarkup(caseName: StaticFixturePage): string {
  const links: Record<string, string> = {
    ...
    "policy-vendor-panel-privacy-links": [
      ...
      `<p>Trusted partners and IAB vendors</p><a href="https://privacy.example-vendor.test/privacy-notice">Example Vendor Privacy Notice</a>`,
      `<p>Partnerliste und IAB-Anbieter</p><a href="https://privacy.example-anbieter.test/datenschutzerklaerung">Example Anbieter Datenschutzerklärung</a>`,
      `<p>Liste des partenaires et fournisseurs IAB</p><a href="https://privacy.example-fournisseur.test/politique-de-confidentialite">Example Fournisseur Politique de confidentialité</a>`,
      `<p>Lista de proveedores y socios IAB</p><a href="https://privacy.example-proveedor.test/politica-de-privacidad">Example Proveedor Política de privacidad</a>`,
      `<p>Lista fornitori e partner IAB</p><a href="https://privacy.example-fornitore-two.test/informativa-privacy">Example Fornitore Informativa sulla privacy</a>`,
      `<p>Partnerlijst en IAB-aanbieders</p><a href="https://privacy.example-leverancier.test/privacybeleid">Example Leverancier Privacybeleid</a>`,
      `<p>Lista zaufanych partnerów i dostawców IAB</p><a href="https://privacy.example-dostawca.test/polityka-prywatnosci">Example Dostawca Polityka prywatności</a>`,
      `</section>`,
    ].join(" | "),
