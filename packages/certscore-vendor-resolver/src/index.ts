...
export const CANONICAL_VENDOR_RESOLVER_VERSION = "certscore-vendor-resolver-2026-07-14-wave13-aggressive-1600-scan-batch";
...
const rules: VendorRule[] = [
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/(?:www\.youtube\.com|www\.youtube-nocookie\.com)\/embed(?:\/[A-Za-z0-9_-]+)?(?:\?|$)/i, /\/iframe_api\b/i, /\/player_api\b/i, /\/s\/(?:_|player)\//i, /\/generate_204\b/i, /^https:\/\/www\.youtube\.com\/youtubei\/v1\/log_event(?:\?|$)/i],
    requireUrlPatternMatch: true,
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/cdn\.gladly\.com\/(?:chat-sdk\/widget\.js|assets\/chat-sdk\/[A-Za-z0-9_.-]+)(?:\?|$)/i],
    requireUrlPatternMatch: true,
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/rum\.hlx\.page\/\.rum\/[A-Za-z0-9_-]+\/[A-Za-z0-9_-]+\/dist\/(?:micro|rum-standalone)\.js(?:\?|$)/i],
    requireUrlPatternMatch: true,
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/[A-Za-z0-9-]+\.brightspotcdn\.com\/dims4\/[^?#]+(?:\?|$)/i],
    requireUrlPatternMatch: true,
  ...
  },
  {
    ...
    regulatoryRelevance: ["cdn", "media_delivery", "publisher_infrastructure"],
    confidence: 0.98,
    hostPatterns: [/^static-ah\.xhcdn\.com$/i, /^ic-(?:vt|vrm|nss)\.xhcdn\.com$/i],
    urlPatterns: [/^https:\/\/static-ah\.xhcdn\.com\/xh-desktop\/[^?#]+(?:\?|$)/i, /^https:\/\/ic-(?:vt|vrm|nss)\.xhcdn\.com\/a\/[^?#]+(?:\?|$)/i],
    requireUrlPatternMatch: true,
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/assets-cdn77\.xnxx-cdn\.com\/v-[a-f0-9]+\/v3\/[^?#]+(?:\?|$)/i],
    requireUrlPatternMatch: true,
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/ir\.ebaystatic\.com\/cr\/(?:ebay-rum\/cdn-assets|v\/c01)\/[^?#]+(?:\?|$)/i, /^https:\/\/i\.ebayimg\.com\/(?:00|images)\/[^?#]+(?:\?|$)/i],
    requireUrlPatternMatch: true,
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/img(?:\.lb(?:\.staging)?)?\.wbmdstatic\.com\/(?:vim\/live\/|webmd_static_vue\/)[^?#]+(?:\?|$)/i],
    requireUrlPatternMatch: true,
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/m\.media-amazon\.com\/images\/G\/(?:01\/gno|42)\/[^?#]+(?:\?|$)/i, /^https:\/\/images-eu\.ssl-images-amazon\.com\/images\/G\/42\/[^?#]+(?:\?|$)/i],
    requireUrlPatternMatch: true,
