...
interface VendorRule {
  ...
  requireHostPatternForCookie?: boolean;
  basisLabel: string;
}
...
const rules: VendorRule[] = [
  ...
  },
  {
    ...
    confidence: 0.94,
    hostPatterns: [/^bat\.bing\.com$/i, /^c\.bing\.com$/i, /^www\.bing\.com$/i, /^\.?bing\.com$/i],
    urlPatterns: [/\/(?:action|bat\.js|p\/action|collect|uet)\b/i],
    cookiePatterns: [/^MUID$/i, /^MR$/i, /^SRM_B$/i, /^_uet/i, /^_uetsid$/i, /^_uetvid$/i],
    storageKeyPatterns: [/^_uet/i],
    requireHostPatternForCookie: true,
    basisLabel: "microsoft_bing_uet_endpoint_or_cookie",
  },
  {
    entity: "DataDome Solutions SAS",
    vendor: "DataDome",
    product: "DataDome Bot Protection",
    purpose: "security",
    regulatoryRelevance: ["security", "bot_detection", "fraud_prevention"],
    confidence: 0.92,
    hostPatterns: [/\.datadome\.co$/i, /\.captcha-delivery\.com$/i],
    cookiePatterns: [/^datadome$/i],
    basisLabel: "datadome_security_endpoint_or_cookie",
  },
  {
    entity: "Vercel Inc.",
    vendor: "Vercel",
    ...
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "performance_monitoring"],
    confidence: 0.91,
    hostPatterns: [/^vitals\.vercel-insights\.com$/i, /^va\.vercel-scripts\.com$/i],
    urlPatterns: [/\/v1\/vitals\b/i, /\/_vercel\/insights/i],
    basisLabel: "vercel_analytics_runtime",
  },
  {
    ...
    product: "cdnjs",
    purpose: "infrastructure",
    regulatoryRelevance: ["cdn", "third_party_runtime", "script_delivery"],
    confidence: 0.91,
    hostPatterns: [/^cdnjs\.cloudflare\.com$/i],
    basisLabel: "cloudflare_cdnjs_host",
  },
  {
  ...
  },
  {
    ...
    basisLabel: "datatables_cdn_host",
  },
  {
    entity: "Meta Platforms, Inc.",
    vendor: "Meta",
    product: "Instagram CDN",
    purpose: "infrastructure",
    regulatoryRelevance: ["embedded_content", "cdn", "media_delivery", "third_party_runtime"],
    confidence: 0.88,
    hostPatterns: [/^scontent-[^.]+\.cdninstagram\.com$/i],
    basisLabel: "instagram_embed_cdn_host",
  },
  {
    entity: "LiveRamp Holdings, Inc.",
    vendor: "LiveRamp",
    product: "LiveRamp Privacy Manager",
    purpose: "consent_management",
    regulatoryRelevance: ["consent_management", "preference_tooling"],
    confidence: 0.9,
    hostPatterns: [/^(?:geo|launchpad|launchpad-wrapper)\.privacymanager\.io$/i],
    urlPatterns: [/\/(?:launchpad|privacy|geo|consent|wrapper)\b/i],
    basisLabel: "liveramp_privacy_manager_endpoint",
  },
  {
    entity: "Microsoft Corporation",
    vendor: "Microsoft",
    ...
    regulatoryRelevance: ["consent", "advertising", "ad_measurement", "cross_site_tracking"],
    confidence: 0.92,
    hostPatterns: [/^bat\.bing\.com$/i, /^c\.bing\.com$/i],
    basisLabel: "microsoft_bing_ad_endpoint_host",
  },
  {
    entity: "Xandr, Inc.",
    vendor: "Xandr",
    ...
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads", "cross_site_tracking"],
    confidence: 0.93,
    hostPatterns: [/\.adnxs\.com$/i, /\.appnexus\.com$/i],
    cookiePatterns: [/^uuid2$/i, /^anj$/i],
    basisLabel: "xandr_appnexus_endpoint_or_cookie",
  },
  {
    entity: "Amobee, Inc.",
    vendor: "Amobee",
    ...
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.turn\.com$/i],
    basisLabel: "amobee_turn_endpoint",
  },
  {
    entity: "BeeswaxIO Corporation",
    vendor: "Beeswax",
    product: "Beeswax",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.beeswax\.com$/i],
    cookiePatterns: [/^bito$/i, /^bitoIsSecure$/i],
    basisLabel: "beeswax_endpoint_or_cookie",
  },
  {
    entity: "Equativ",
    vendor: "Equativ",
    product: "Smart AdServer",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "ad_server", "programmatic_ads"],
    confidence: 0.91,
    hostPatterns: [/\.smartadserver\.com$/i],
    cookiePatterns: [/^sasd2?$/i],
    basisLabel: "equativ_smart_adserver_endpoint_or_cookie",
  },
  {
    entity: "Yandex LLC",
    vendor: "Yandex",
    ...
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "audience_measurement"],
    confidence: 0.91,
    hostPatterns: [/^mc\.yandex\.(?:com|ru)$/i, /\.yandex\.(?:com|ru)$/i],
    cookiePatterns: [/^yandexuid$/i, /^yuidss$/i, /^ymex$/i],
    basisLabel: "yandex_metrica_endpoint_or_cookie",
  },
  {
    entity: "Yandex LLC",
    vendor: "Yandex",
    ...
    regulatoryRelevance: ["consent", "advertising", "ad_measurement", "cross_site_tracking"],
    confidence: 0.9,
    hostPatterns: [/^mc\.yandex\.(?:com|ru)$/i, /\.webvisor\.org$/i],
    cookiePatterns: [/^sync_cookie_csrf$/i, /^yabs-sid$/i],
    basisLabel: "yandex_ads_endpoint_or_cookie",
  },
  {
    entity: "Baidu, Inc.",
    vendor: "Baidu",
    product: "Baidu Analytics",
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "audience_measurement"],
    confidence: 0.92,
    hostPatterns: [/^hm\.baidu\.com$/i, /^hmma\.baidu\.com$/i],
    urlPatterns: [/\/hm(?:\.js|\.gif)\b/i, /[?&]hm=/i],
    cookiePatterns: [/^Hm_lvt_/i, /^Hm_lpvt_/i],
    storageKeyPatterns: [/^Hm_lvt_/i, /^Hm_lpvt_/i],
    basisLabel: "baidu_analytics_endpoint_or_cookie",
  },
  {
    ...
    cookiePatterns: [/^visitor-id$/i],
    requireHostPatternForCookie: true,
    basisLabel: "media_net_endpoint_or_cookie",
  },
  {
    entity: "Sharethrough Inc.",
    vendor: "Sharethrough",
    product: "Sharethrough",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.sharethrough\.com$/i],
    basisLabel: "sharethrough_endpoint",
  },
  {
    ...
    product: "RTB House",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "retargeting"],
    confidence: 0.91,
    hostPatterns: [/(^|\.)creativecdn\.com$/i, /\.rtbhouse\.com$/i],
    basisLabel: "rtb_house_endpoint",
  },
  {
    entity: "Blis Media Limited",
    vendor: "Blis",
    product: "Blis",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "location_based_advertising"],
    confidence: 0.9,
    hostPatterns: [/\.blismedia\.com$/i],
    basisLabel: "blis_location_ad_endpoint",
  },
  {
    entity: "Yahoo Inc.",
    vendor: "Yahoo",
    product: "Yahoo Advertising",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "ad_measurement", "cross_site_tracking"],
    confidence: 0.9,
    hostPatterns: [/^ups\.analytics\.yahoo\.com$/i, /^pbs\.yahoo\.com$/i, /\.yahoo\.com$/i],
    cookiePatterns: [/^A3$/i],
    requireHostPatternForCookie: true,
    basisLabel: "yahoo_advertising_endpoint_or_cookie",
  },
  {
    entity: "Marigold Engage+",
    vendor: "Sailthru",
    product: "Sailthru",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "marketing_automation", "personalization"],
    confidence: 0.9,
    hostPatterns: [/\.sail-horizon\.com$/i, /\.sailthru\.com$/i],
    basisLabel: "sailthru_personalization_endpoint",
  },
  {
    entity: "Lightbox OOH Video Network",
    vendor: "Lightbox",
    product: "Lightbox",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "ad_creative_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.lightboxcdn\.com$/i],
    basisLabel: "lightbox_ad_creative_endpoint",
  },
  {
    entity: "Innovid Corp.",
    vendor: "Innovid",
    ...
    confidence: 0.9,
    hostPatterns: [/^[cp]\.tvpixel\.com$/i],
    basisLabel: "tvpixel_ad_measurement_endpoint",
  },
  {
    entity: "Amazon Web Services, Inc.",
    vendor: "AWS",
    product: "AWS MediaTailor",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "server_side_ad_insertion", "video_ad_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.mediatailor\.[^.]+\.amazonaws\.com$/i],
    basisLabel: "aws_mediatailor_ssai_endpoint",
  },
  {
    entity: "Conviva Inc.",
    vendor: "Conviva",
    product: "Conviva",
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "video_quality_of_experience"],
    confidence: 0.91,
    hostPatterns: [/\.cws\.conviva\.com$/i],
    basisLabel: "conviva_video_qoe_endpoint",
  },
  {
    ...
    confidence: 0.91,
    hostPatterns: [/\.mparticle\.com$/i],
    urlPatterns: [/\/(?:events|jssdk|v\d+)\b/i],
    basisLabel: "mparticle_cdp_endpoint",
  },
  {
    ...
    product: "Parse.ly",
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "content_analytics"],
    confidence: 0.92,
    hostPatterns: [/\.parsely\.com$/i],
    urlPatterns: [/\/(?:p\.js|track|data|analytics|experiments)\b/i],
    basisLabel: "parsely_analytics_endpoint",
  },
  {
    ...
    regulatoryRelevance: ["consent", "analytics", "audience_measurement"],
    confidence: 0.92,
    hostPatterns: [/\.chartbeat\.com$/i],
    basisLabel: "chartbeat_analytics_endpoint",
  },
  {
    entity: "Dynata, LLC",
    vendor: "Dynata",
    product: "Research Now",
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "research_pixel", "audience_measurement"],
    confidence: 0.9,
    hostPatterns: [/\.researchnow\.com$/i],
    basisLabel: "dynata_researchnow_pixel",
  },
  {
    ...
    product: "FreeWheel",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "video_ad_delivery"],
    confidence: 0.91,
    hostPatterns: [/\.fwmrm\.net$/i],
    basisLabel: "freewheel_video_ad_endpoint",
  },
  {
    entity: "Beachfront Media LLC",
    vendor: "Beachfront",
    product: "Beachfront",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "video_ad_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.bfmio\.com$/i],
    basisLabel: "beachfront_ad_endpoint",
  },
  {
    entity: "Nexxen International Ltd.",
    vendor: "Unruly",
    product: "Unruly",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "video_ad_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.unrulymedia\.com$/i, /\.1rx\.io$/i],
    basisLabel: "nexxen_unruly_ad_endpoint",
  },
  {
    entity: "True Anthem, Inc.",
    vendor: "True Anthem",
    product: "True Anthem",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "marketing_automation", "social_publishing"],
    confidence: 0.9,
    hostPatterns: [/^tru\.am$/i],
    basisLabel: "true_anthem_social_marketing_endpoint",
  },
  {
    entity: "Iterate HQ Inc.",
    vendor: "Iterate",
    product: "Iterate Surveys",
    purpose: "customer_support",
    regulatoryRelevance: ["feedback", "surveys", "customer_support"],
    confidence: 0.9,
    hostPatterns: [/\.iteratehq\.com$/i],
    basisLabel: "iterate_feedback_survey_endpoint",
  },
  {
    ...
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads", "cross_site_tracking"],
    confidence: 0.91,
    hostPatterns: [/\.stackadapt\.com$/i, /\.srv\.stackadapt\.com$/i],
    cookiePatterns: [/^sa-user-id(?:-v\d+)?$/i, /^sd-session-id$/i],
    basisLabel: "fable_stackadapt_endpoint_or_cookie",
  },
  {
    entity: "Intent IQ, LLC",
    vendor: "Intent IQ",
    product: "Intent IQ",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "identity_resolution", "cross_site_tracking"],
    confidence: 0.9,
    hostPatterns: [/\.intentiq\.com$/i, /\.alcmpn\.com$/i],
    cookiePatterns: [/^IQPData$/i, /^IQver$/i, /^intentIQ(?:CDate)?$/i],
    basisLabel: "fable_intentiq_endpoint_or_cookie",
  },
  {
    ...
    product: "LiveIntent",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "identity_resolution", "email_advertising"],
    confidence: 0.9,
    hostPatterns: [/\.liadm\.com$/i],
    cookiePatterns: [/^_li_ss$/i, /^idx$/i, /^lidid$/i],
    basisLabel: "fable_liveintent_endpoint_or_cookie",
  },
  {
    entity: "Novatiq Limited",
    vendor: "Novatiq",
    product: "Novatiq",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "identity_resolution"],
    confidence: 0.9,
    hostPatterns: [/\.novatiq\.com$/i],
    cookiePatterns: [/^nova(?:exp|sig|syncts|uid)$/i],
    basisLabel: "fable_novatiq_endpoint_or_cookie",
  },
  {
    entity: "Throtle, Inc.",
    vendor: "Throtle",
    product: "Throtle",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "identity_resolution", "data_broker"],
    confidence: 0.9,
    hostPatterns: [/\.thrtle\.com$/i, /\.redinuid\.imrworldwide\.com$/i],
    cookiePatterns: [/^csuuid$/i],
    basisLabel: "fable_throtle_endpoint_or_cookie",
  },
  {
    ...
    cookiePatterns: [/^tluid$/i, /^sync$/i],
    basisLabel: "fable_triplelift_endpoint_or_cookie",
  },
  {
    entity: "Zeta Global Holdings Corp.",
    vendor: "Zeta Global",
    product: "Zeta Global / Rezync",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "identity_resolution", "cross_site_tracking"],
    confidence: 0.9,
    hostPatterns: [/\.rezync\.com$/i, /\.rocketfuel\.com$/i],
    cookiePatterns: [/^admtr$/i, /^zync-uuid$/i],
    basisLabel: "fable_zeta_rezync_endpoint_or_cookie",
  },
  {
    entity: "Kargo Global, Inc.",
    vendor: "Kargo",
    product: "Kargo",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.kargo\.com$/i],
    cookiePatterns: [/^ktcid$/i],
    basisLabel: "fable_kargo_endpoint_or_cookie",
  },
  {
    ...
    product: "MPS",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "publisher_ad_stack"],
    confidence: 0.9,
    hostPatterns: [/^mps\.nbcuni\.com$/i, /^app\.mps\.vsnt\.net$/i, /^sli\.webmd\.com$/i],
    cookiePatterns: [/^adEdition$/i],
    requireHostPatternForCookie: true,
    basisLabel: "fable_nbcu_mps_ad_stack",
  },
  {
    entity: "Sportradar AG",
    vendor: "Sportradar",
    product: "Sportradar Widgets",
    purpose: "infrastructure",
    regulatoryRelevance: ["embedded_content", "sports_widgets", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/\.sportradarserving\.com$/i, /\.sportradar\.com$/i, /\.sir\.sportradar\.com$/i, /\.sportradar\.us$/i],
    basisLabel: "fable_sportradar_widget_endpoint",
  },
  {
    entity: "Trustmary Group Oy",
    vendor: "Trustmary",
    product: "Trustmary Reviews Widget",
    purpose: "customer_support",
    regulatoryRelevance: ["reviews_widget", "customer_support", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/\.trustmary\.com$/i, /\.trustmary\.io$/i],
    basisLabel: "fable_trustmary_widget_endpoint",
  },
  {
    entity: "Adobe Inc.",
    vendor: "Adobe",
    ...
    purpose: "infrastructure",
    regulatoryRelevance: ["font_delivery", "cdn", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/\.typekit\.net$/i],
    basisLabel: "fable_adobe_fonts_endpoint",
  },
  {
    entity: "Fonticons, Inc.",
    vendor: "Font Awesome",
    product: "Font Awesome Kit",
    purpose: "infrastructure",
    regulatoryRelevance: ["font_delivery", "cdn", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/\.fontawesome\.com$/i],
    basisLabel: "fable_fontawesome_endpoint",
  },
  {
    entity: "Google LLC",
    vendor: "Google",
    product: "Google Maps / Places",
    purpose: "infrastructure",
    regulatoryRelevance: ["maps", "embedded_content", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/^maps\.googleapis\.com$/i, /^maps\.gstatic\.com$/i, /^places\.googleapis\.com$/i],
    basisLabel: "fable_google_maps_endpoint",
  },
  {
    entity: "Google LLC",
    vendor: "Google",
    ...
    regulatoryRelevance: ["security", "bot_detection", "fraud_prevention"],
    confidence: 0.9,
    hostPatterns: [/^www\.google\.com$/i, /^accounts\.google\.com$/i],
    urlPatterns: [/\/recaptcha\//i],
    cookiePatterns: [/^_GRECAPTCHA$/i],
    requireUrlPatternMatch: true,
    basisLabel: "fable_google_recaptcha_endpoint_or_cookie",
  },
  {
    entity: "Vimeo.com, Inc.",
    vendor: "Vimeo",
    product: "Vimeo Player",
    purpose: "infrastructure",
    regulatoryRelevance: ["video_player", "embedded_content", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/^player\.vimeo\.com$/i, /(^|\.)vimeo\.com$/i],
    basisLabel: "fable_vimeo_player_endpoint",
  },
  {
    entity: "JW Player",
    vendor: "JW Player",
    ...
    regulatoryRelevance: ["video_player", "embedded_content", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/\.jwplayer\.com$/i],
    basisLabel: "fable_jwplayer_endpoint",
  },
  {
    entity: "UsableNet Inc.",
    vendor: "UsableNet",
    product: "UsableNet Accessibility",
    purpose: "infrastructure",
    regulatoryRelevance: ["accessibility", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/\.usablenet\.com$/i],
    basisLabel: "fable_usablenet_endpoint",
  },
  {
    entity: "SFBX",
    vendor: "SFBX",
    product: "AppConsent CMP",
    purpose: "consent_management",
    regulatoryRelevance: ["consent_management", "preference_tooling"],
    confidence: 0.9,
    hostPatterns: [/\.appconsent\.io$/i],
    basisLabel: "fable_sfbx_appconsent_endpoint",
  },
  {
    entity: "Warner Bros. Discovery, Inc.",
    vendor: "Warner Bros. Discovery",
    product: "WBD Privacy Portal",
    purpose: "consent_management",
    regulatoryRelevance: ["consent_management", "privacy_portal"],
    confidence: 0.9,
    hostPatterns: [/^www\.wbdprivacy\.com$/i],
    cookiePatterns: [/^wbdFch$/i],
    basisLabel: "fable_wbd_privacy_portal_or_cookie",
  },
  {
    entity: "Salesforce, Inc.",
    vendor: "Salesforce",
    product: "Salesforce Personalization / Evergage",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "marketing_automation", "personalization"],
    confidence: 0.9,
    hostPatterns: [/\.evgnet\.com$/i],
    basisLabel: "fable_salesforce_evergage_endpoint",
  },
  {
    entity: "Statsig, Inc.",
    vendor: "Statsig",
    product: "Statsig",
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "experimentation"],
    confidence: 0.9,
    hostPatterns: [/\.statsigapi\.net$/i],
    basisLabel: "fable_statsig_endpoint",
  },
  {
    entity: "Marfeel Solutions SL",
    vendor: "Marfeel",
    product: "Marfeel",
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "audience_measurement"],
    confidence: 0.9,
    hostPatterns: [/\.mrf\.io$/i, /\.marfeel\.com$/i],
    basisLabel: "fable_marfeel_endpoint",
  },
  {
    entity: "Nielsen Holdings plc",
    vendor: "Nielsen",
    product: "Nielsen Audience Measurement",
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "audience_measurement"],
    confidence: 0.9,
    hostPatterns: [/\.imrworldwide\.com$/i],
    basisLabel: "fable_nielsen_endpoint",
  },
  {
    ...
    regulatoryRelevance: ["performance_monitoring", "telemetry_diagnostics"],
    confidence: 0.9,
    hostPatterns: [/\.go-mpulse\.net$/i],
    basisLabel: "fable_akamai_mpulse_endpoint",
  },
  {
    entity: "Akamai Technologies, Inc.",
    vendor: "Akamai",
    ...
    confidence: 0.9,
    hostPatterns: [/\.akamaized\.net$/i],
    basisLabel: "fable_akamai_cdn_endpoint",
  },
  {
    ...
    purpose: "infrastructure",
    regulatoryRelevance: ["cdn", "site_assets", "media_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.ctfassets\.net$/i],
    basisLabel: "fable_contentful_assets_endpoint",
  },
  {
    entity: "CloudFront",
    vendor: "AWS",
    ...
    purpose: "infrastructure",
    regulatoryRelevance: ["cdn", "site_assets", "third_party_runtime"],
    confidence: 0.9,
    hostPatterns: [/\.cloudfront\.net$/i],
    basisLabel: "fable_cloudfront_distribution_endpoint",
  },
  {
    entity: "Google LLC",
    vendor: "Google",
    ...
    basisLabel: "fable_google_hosted_libraries_endpoint",
  },
  {
    entity: "Google LLC",
    vendor: "Google",
    ...
    purpose: "infrastructure",
    regulatoryRelevance: ["cdn", "site_assets", "cloud_storage"],
    confidence: 0.88,
    hostPatterns: [/\.storage\.googleapis\.com$/i],
    basisLabel: "fable_google_cloud_storage_assets_endpoint",
  },
  {
    entity: "PulsePoint, Inc.",
    vendor: "PulsePoint",
    product: "PulsePoint / ContextWeb",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads", "health_adtech"],
    confidence: 0.9,
    hostPatterns: [/\.contextweb\.com$/i],
    cookiePatterns: [/^data-cl$/i],
    basisLabel: "fable_pulsepoint_contextweb_endpoint_or_cookie",
  },
  {
    entity: "DeepIntent, Inc.",
    vendor: "DeepIntent",
    product: "DeepIntent",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "health_adtech", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.deepintent\.com$/i],
    basisLabel: "fable_deepintent_endpoint",
  },
  {
    entity: "IPONWEB",
    vendor: "BidSwitch",
    product: "BidSwitch",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads", "cookie_sync"],
    confidence: 0.9,
    hostPatterns: [/\.bidswitch\.net$/i],
    cookiePatterns: [/^tuuid(?:_lu)?$/i],
    basisLabel: "fable_bidswitch_endpoint_or_cookie",
  },
  {
    entity: "ID5 Technology Ltd",
    vendor: "ID5",
    product: "ID5",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "identity_resolution"],
    confidence: 0.9,
    hostPatterns: [/\.id5-sync\.com$/i, /\.id5\.io$/i],
    basisLabel: "fable_id5_endpoint",
  },
  {
    entity: "33Across Inc.",
    vendor: "33Across",
    product: "33Across",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "identity_resolution", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/(^|\.)33across\.com$/i],
    basisLabel: "fable_33across_endpoint",
  },
  {
    entity: "Sovrn Holdings, Inc.",
    vendor: "Sovrn",
    product: "Sovrn / Lijit",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.lijit\.com$/i, /\.sovrn\.com$/i],
    basisLabel: "fable_sovrn_lijit_endpoint",
  },
  {
    entity: "Yieldmo, Inc.",
    vendor: "Yieldmo",
    ...
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.yieldmo\.com$/i],
    basisLabel: "fable_yieldmo_endpoint",
  },
  {
    entity: "Adform A/S",
    vendor: "Adform",
    product: "Adform",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads", "ad_measurement"],
    confidence: 0.9,
    hostPatterns: [/\.adform\.net$/i],
    basisLabel: "fable_adform_endpoint",
  },
  {
    entity: "Simpli.fi Holdings, Inc.",
    vendor: "Simpli.fi",
    product: "Simpli.fi",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.simpli\.fi$/i],
    basisLabel: "fable_simplifi_endpoint",
  },
  {
    entity: "Sonobi, Inc.",
    vendor: "Sonobi",
    ...
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.sonobi\.com$/i],
    basisLabel: "fable_sonobi_endpoint",
  },
  {
    entity: "Teads",
    vendor: "Teads",
    product: "Teads",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "video_ad_delivery", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.teads\.tv$/i],
    basisLabel: "fable_teads_endpoint",
  },
  {
    entity: "Nexxen International Ltd.",
    vendor: "Tremor Video",
    product: "Tremor Video",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "video_ad_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.tremorhub\.com$/i],
    basisLabel: "fable_tremor_video_endpoint",
  },
  {
    entity: "Basis Technologies",
    vendor: "SiteScout",
    product: "SiteScout",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.sitescout\.com$/i],
    basisLabel: "fable_sitescout_endpoint",
  },
  {
    entity: "Platform161",
    vendor: "Platform161",
    product: "Platform161 Creative Serving",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "creative_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.creative-serving\.com$/i],
    basisLabel: "fable_platform161_endpoint",
  },
  {
    entity: "Confiant Inc.",
    vendor: "Confiant",
    product: "Confiant",
    purpose: "security",
    regulatoryRelevance: ["security", "ad_verification", "malvertising_protection"],
    confidence: 0.9,
    hostPatterns: [/\.confiant-integrations\.net$/i, /\.confiant\.com$/i],
    basisLabel: "fable_confiant_endpoint",
  },
  {
    ...
    product: "SpeedCurve",
    purpose: "performance_monitoring",
    regulatoryRelevance: ["performance_monitoring", "analytics"],
    confidence: 0.9,
    hostPatterns: [/\.speedcurve\.com$/i],
    basisLabel: "fable_speedcurve_endpoint",
  },
  {
    entity: "Brand Metrics Sweden AB",
    vendor: "Brand Metrics",
    product: "Brand Metrics",
    purpose: "analytics",
    regulatoryRelevance: ["consent", "analytics", "brand_lift_measurement"],
    confidence: 0.9,
    hostPatterns: [/\.brandmetrics\.com$/i],
    basisLabel: "fable_brandmetrics_endpoint",
  },
  {
    entity: "TechTarget, Inc.",
    vendor: "TechTarget",
    product: "TechTarget Intent Data",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "intent_data", "b2b_marketing"],
    confidence: 0.9,
    hostPatterns: [/\.techtarget\.com$/i],
    basisLabel: "fable_techtarget_endpoint",
  },
  {
    entity: "Opera Norway AS",
    vendor: "Opera Ads",
    product: "Opera Ads",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.opera\.com$/i, /\.opera-ads\.com$/i],
    basisLabel: "fable_opera_ads_endpoint",
  },
  {
    ...
    product: "ZoomInfo",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "b2b_marketing", "data_broker"],
    confidence: 0.9,
    hostPatterns: [/\.zoominfo\.com$/i],
    basisLabel: "fable_zoominfo_endpoint",
  },
  {
    entity: "Salesloft, Inc.",
    vendor: "Salesloft",
    product: "Salesloft",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "marketing_automation", "b2b_marketing"],
    confidence: 0.9,
    hostPatterns: [/\.salesloft\.com$/i],
    basisLabel: "fable_salesloft_endpoint",
  },
  {
    entity: "Bidtellect, Inc.",
    vendor: "Bidtellect",
    product: "Bidtellect",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.bidtellect\.com$/i],
    basisLabel: "fable_bidtellect_endpoint",
  },
  {
    entity: "Connatix Native Exchange Inc.",
    vendor: "Connatix",
    product: "Connatix Video",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "video_ad_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.connatix\.com$/i],
    basisLabel: "fable_connatix_endpoint",
  },
  {
    entity: "Brightspot",
    vendor: "Brightspot",
    product: "Brightspot CDN",
    purpose: "infrastructure",
    regulatoryRelevance: ["cdn", "site_assets"],
    confidence: 0.9,
    hostPatterns: [/\.brightspotcdn\.com$/i],
    basisLabel: "fable_brightspot_cdn_endpoint",
  },
  {
    entity: "Primis",
    vendor: "Primis",
    product: "Primis Video",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "video_ad_delivery"],
    confidence: 0.9,
    hostPatterns: [/\.primis\.tech$/i],
    cookiePatterns: [/^acx$/i],
    basisLabel: "fable_primis_endpoint_or_cookie",
  },
  {
    entity: "RTBwise",
    vendor: "RTBwise",
    ...
    regulatoryRelevance: ["consent", "advertising", "programmatic_ads"],
    confidence: 0.9,
    hostPatterns: [/\.rtbwise\.com$/i],
    basisLabel: "fable_rtbwise_endpoint",
  },
  {
    entity: "Temu",
    vendor: "Temu",
    product: "Temu Retail Pixel",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "retail_pixel"],
    confidence: 0.86,
    hostPatterns: [/^www\.temu\.com$/i],
    basisLabel: "fable_temu_retail_pixel_endpoint",
  },
  {
    entity: "X Corp.",
    vendor: "X",
    product: "Twitter / X Ads Pixel",
    purpose: "advertising",
    regulatoryRelevance: ["consent", "advertising", "social_pixel"],
    confidence: 0.9,
    hostPatterns: [/^static\.ads-twitter\.com$/i, /\.ads-twitter\.com$/i],
    basisLabel: "fable_x_ads_pixel_endpoint",
  },
  {
    entity: "Cloudflare, Inc.",
    vendor: "Cloudflare",
  ...
  },
  {
    ...
    confidence: 0.9,
    cookiePatterns: [/^_abck$/i, /^bm_s$/i, /^bm_so$/i, /^bm_ss$/i, /^bm_sv$/i, /^bm_sz$/i, /^ak_bmsc$/i, /^akaas_/i, /^akamai_/i],
  ...
  },
  {
    ...
    confidence: 0.96,
    hostPatterns: [/^www\.google-analytics\.com$/i, /^region\d+\.google-analytics\.com$/i],
    urlPatterns: [
  ...
  },
  {
    ...
    confidence: 0.95,
    hostPatterns: [/^(?:www|scripts|c|k|r|n|f)\.clarity\.ms$/i, /^\.?clarity\.ms$/i],
    urlPatterns: [/^https:\/\/(?:www|scripts|c|k|r|n|f)\.clarity\.ms\/(?:tag|collect|c\.gif|events?)\b/i],
    cookiePatterns: [/^_clck$/i, /^_clsk$/i, /^CLID$/i, /^SM$/i, /^ANONCHK$/i, /^MR$/i, /^MUID$/i],
  ...
  },
  {
    ...
    urlPatterns: [/\/beacon(?:\.min)?\.js\b/i, /\/cdn-cgi\/rum\b/i],
    basisLabel: "cloudflare_web_analytics_endpoint",
  },
  {
    entity: "Cloudflare, Inc.",
    vendor: "Cloudflare",
...
export function resolveVendorDisplayCategory(input: VendorDisplayCategoryInput): VendorDisplayCategory {
  ...
  if (/jsdelivr|cdn\b|font_delivery|font delivery|content delivery|site_assets|site assets|static_assets|static assets|script_delivery|script delivery|cloudfront|storage\.googleapis|ctfassets/.test(haystack)) {
    return "CDN";
  }
  if (/maps|video_player|video player|embedded_content|embedded content|sports_widgets|sports widgets|reviews_widget|reviews widget|accessibility/.test(haystack)) {
    return "CDN";
  }
  ...
  if (/customer_support|customer support|feedback|surveys|reviews/.test(haystack)) {
  ...
  for (const input of inputs) {
    ...
    for (const rule of rules) {
      ...
      const matchedCookie = cookieName
        ? matchesAny(cookieName, rule.cookiePatterns) && (!rule.requireHostPatternForCookie || matchedHost)
        : false;
