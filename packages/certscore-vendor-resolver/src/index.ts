...
export const CANONICAL_VENDOR_RESOLVER_VERSION = "certscore-vendor-resolver-2026-07-13-wave8-evidence-batch";
...
const rules: VendorRule[] = [
  ...
  },
  {
    ...
    urlPatterns: [/^https:\/\/cdn\.userway\.org\/widget\.js\b/i],
    requireUrlPatternMatch: true,
