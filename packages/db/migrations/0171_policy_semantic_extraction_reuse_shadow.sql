...
comment on constraint scan_model_review_artifacts_review_kind_check
  ...
  'Static, parallel, Nano, and retained-extraction shadow artifacts are internal and non-projectable; only an approved-model canonical policy_semantic artifact may enter normalized concerns.';
