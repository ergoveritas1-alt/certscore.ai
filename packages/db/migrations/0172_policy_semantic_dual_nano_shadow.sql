...
comment on constraint scan_model_review_artifacts_review_kind_check
  ...
  'Static and all shadow policy artifacts are internal and non-projectable; only an approved-model canonical policy_semantic artifact may enter normalized concerns.';
