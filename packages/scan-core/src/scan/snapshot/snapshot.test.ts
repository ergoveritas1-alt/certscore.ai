...
function makeSnapshot(overrides: Partial<ScanSnapshot> = {}): ScanSnapshot {
  return {
    ...
    investmentOutperformanceLanguagePresent: false,
    guaranteedReturnLanguagePresent: false,
    lowRiskHighReturnLanguagePresent: false,
    hypotheticalOrBacktestLanguagePresent: false,
    testimonialOrReviewBlockNearFinancialClaimPresent: false,
    riskDisclosureTextPresent: false,
    claimCtaBlockPresent: false,
    financialClaimWithCtaCount: 0,
    aboutPagePresent: false,
    teamOrLeadershipPagePresent: false,
    jurisdictionOrOperatingEntityTextPresent: false,
    registrationClaimPresent: false,
    registrationIdentifierPresent: false,
    multipleEntityNamesDetected: false,
    entityTransparencySurfaceScore: null,
    pricingPagePresent: false,
    feeRelatedTextPresent: false,
    feeSchedulePresent: false,
    withdrawalTermsPresent: false,
    cancellationTermsPresent: false,
    accountClosureTermsPresent: false,
    promoPriceOrFreeClaimPresent: false,
    variableFeeLanguageWithoutExplanation: false,
    materialFeeTermsMinLinkDepth: null,
    leverageLanguagePresent: false,
    marginTradingLanguagePresent: false,
    optionsOrFuturesLanguagePresent: false,
    perpetualsOrDerivativesLanguagePresent: false,
    stakingApyLanguagePresent: false,
    copyTradingLanguagePresent: false,
    aiTradingLanguagePresent: false,
    lossRiskDisclosureTextPresent: false,
    highRiskProductExplainerPagePresent: false,
    highRiskProductSignalCount: 0,
    certscoreOverall: 80,
    privacyScore: 82,
    consentScore: 78,
    trackerRiskScore: 12,
